...
class McDonStore extends BurgerStore {
    ...
    protected Burger createBurger(String type) {
        Burger burger = null;
        McDonIngredientFactory mcDonIngredientFactory = new McDonIngredientFactory();

        switch (type) {
            case Burger.CHEESE :
                burger = new Cheeseburger(mcDonIngredientFactory);
                burger.setName("McDonalds Style Cheeseburger");
                break;
            case Burger.VEGAN :
                burger = new VeganBurger(mcDonIngredientFactory);
                burger.setName("McDonalds Style VeganBurger");
                break;
            default:
                burger = new Hamburger(mcDonIngredientFactory);
